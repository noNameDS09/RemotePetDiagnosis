...
;
;
const saveScreenshotToIDB = async (imageData, id)=>{
    const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openDB"])('cameraApp', 1, {
        upgrade (db) {
    ...
    await db.put('screenshots', imageData, id);
};
const getScreenshotFromIDB = async (id)=>{
    const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openDB"])('cameraApp', 1);
    const imageData = await db.get('screenshots', id);
    return imageData;
};
function CameraFeed({ id, name, posterUrl, dataAiHint }) {
    ...
    const captureScreenshot = ()=>{
        ...
        if (context) {
            ...
            // Save the image data in IndexedDB
            saveScreenshotToIDB(imageData, id).then(()=>{
                toast({
                ...
                toast({
                    ...
                    description: "Could not save screenshot to IndexedDB.",
                    variant: "destructive"
                });
                console.error(err);
            });
...
function VideoPlayer() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "grid grid-cols-5 grid-rows-7 gap-4 p-32 ",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/src/components/video/Screenshot.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getScreenshotFromIDB = async (id)=>{
    try {
        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openDB"])('cameraApp', 1);
        // Check if the object store exists before fetching
        if (!db.objectStoreNames.contains('screenshots')) {
            console.error("No 'screenshots' object store found.");
            return null;
        }
        // Attempt to get the screenshot by ID
        const imageData = await db.get('screenshots', id);
        // If no data is found, log a message
        if (!imageData) {
            console.warn(`No screenshot found for ID: ${id}`);
        }
        return imageData;
    } catch (error) {
        console.error("Error fetching screenshot from IDB:", error);
        return null;
    }
};
const deleteScreenshotFromIDB = async (id)=>{
    try {
        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$idb$2f$build$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["openDB"])('cameraApp', 1);
...
function ScreenshotViewer({ id }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Fetch screenshot when the component mounts
        const fetchScreenshot = async ()=>{
            if (!id) {
                toast({
                    title: "Invalid ID",
                    description: "No valid ID provided.",
                    variant: "destructive"
                });
                return;
            }
            try {
                const savedScreenshot = await getScreenshotFromIDB(id);
                if (savedScreenshot) {
                ...
                toast({
                    ...
                    description: "Could not fetch screenshot from IndexedDB.",
                    variant: "destructive"
                });
    ...
    const handleDeleteScreenshot = async ()=>{
        try {
            await deleteScreenshotFromIDB(id);
            setScreenshot(null); // Clear the state after deletion
            toast({
            ...
            toast({
                ...
                description: "Could not delete screenshot from IndexedDB.",
                variant: "destructive"
            });
            console.error("Error deleting screenshot:", error);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                children: "Screenshot Viewer"
            }, void 0, false, {
                fileName: "[project]/src/components/video/Screenshot.tsx",
                lineNumber: 87,
                columnNumber: 7
            }, this),
            screenshot ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: "No screenshot available. Please capture one first."
            }, void 0, false, {
                fileName: "[project]/src/components/video/Screenshot.tsx",
                lineNumber: 102,
                columnNumber: 9
...
//# sourceMappingURL=src_components_f563660c._.js.map