        ...
        try {
            if (videoRef.current && typeof document !== 'undefined') {
                if (document.pictureInPictureElement === videoRef.current) {
                    ...
                    // Check if video metadata is loaded (readyState >= 1 means HAVE_METADATA)
    ...
    const takeScreenshot = ()=>{
        ...
        try {
            ...
            canvas.toBlob((blob)=>{
                ...
                a.href = url;
                a.download = `${name.replace(/\s+/g, '_').toLowerCase()}_screenshot.png`;
...
_s(CameraFeed, "vbKtBX/yOfSbQqbTH/IMnzCzeGA=", false, function() {
    return [
...
function VideoPlayer() {
    ...
    const getGridClass = (count)=>{
        ...
        if (count === 3) return 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'; // Adjust as needed, this might look odd. Or use sm:grid-cols-2 and let it wrap.
        return 'grid-cols-1 sm:grid-cols-2'; // For 4 or more, or default
    };
    // Simpler grid that works well for 1-4 cameras
    const gridLayoutClass = ()=>{
        const count = displayedCameras.length;
        if (count === 0) return 'grid-cols-1'; // Fallback for no cameras
        if (count === 1) return 'grid-cols-1';
        // For 2, 3, or 4 cameras, a 2-column layout on medium screens and up is usually good.
        // 3 cameras will have 2 on the first row, 1 on the second.
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                children: displayedCameras.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: `grid ${gridLayoutClass()} gap-4`,
                    children: displayedCameras.map((camera)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: displayedCameras.length === 1 ? 'col-span-full' : displayedCameras.length === 3 && displayedCameras.indexOf(camera) === 2 && window.innerWidth >= 768 ? 'md:col-span-2' : '' // Makes the 3rd camera span full width on md screens if it's the last one
                            ,
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$video$2f$camera$2d$feed$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CameraFeed"], {
                                id: camera.id,
                                name: camera.name,
                                posterUrl: camera.posterUrl,
                                dataAiHint: camera.dataAiHint
                            }, void 0, false, {
                                fileName: "[project]/src/components/video/video-player.tsx",
                                lineNumber: 77,
                                columnNumber: 17
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VideoOff, {
...
_s(VideoPlayer, "JRcUPYjKZ3wjFSWQOl6ugYXrZZc=");
_c = VideoPlayer;
var _c;
...
//# sourceMappingURL=_d0eac738._.js.map